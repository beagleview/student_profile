...
class HollandTestForm(forms.ModelForm):
    """Form for Dr. Holland Career Interest Test"""
    ...
    class Meta:
        ...
        widgets = {
            'realistic_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'investigative_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'artistic_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            ...
            'enterprising_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'conventional_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'primary_type': forms.Select(attrs={'class': 'form-control'}),
            'secondary_type': forms.Select(attrs={'class': 'form-control'}),
        }
        
        labels = {
            'realistic_score': 'นักสำรวจ (Realistic)',
            'investigative_score': 'นักวิจัย (Investigative)',
            'artistic_score': 'นักสร้างสรรค์ (Artistic)',
            'social_score': 'นักสังคม (Social)',
            'enterprising_score': 'นักผจญภัย (Enterprising)',
            'conventional_score': 'นักระบบ (Conventional)',
            'primary_type': 'บุคลิกภาพหลัก',
            'secondary_type': 'บุคลิกภาพรอง'
        }
...
class GardnerTestForm(forms.ModelForm):
    """Form for Dr. Gardner Multiple Intelligence Test"""
    
    class Meta:
        model = GardnerTest
        fields = [
            'linguistic_score', 'logical_score', 'spatial_score', 'musical_score',
            'bodily_score', 'interpersonal_score', 'intrapersonal_score', 'naturalist_score',
            'primary_intelligence', 'secondary_intelligence'
        ]
        
        widgets = {
            'linguistic_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'logical_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'spatial_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'musical_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'bodily_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'interpersonal_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'intrapersonal_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'naturalist_score': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 100,
                'step': 1
            }),
            'primary_intelligence': forms.Select(attrs={'class': 'form-control'}),
            'secondary_intelligence': forms.Select(attrs={'class': 'form-control'}),
        }
        
        labels = {
            'linguistic_score': 'ภาษาศาสตร์ (Linguistic)',
            'logical_score': 'คณิตศาสตร์-ตรรกะ (Logical-Mathematical)',
            'spatial_score': 'มิติสัมพันธ์ (Spatial)',
            'musical_score': 'ดนตรี (Musical)',
            'bodily_score': 'กายเคลื่อนไหว (Bodily-Kinesthetic)',
            'interpersonal_score': 'มนุษยสัมพันธ์ (Interpersonal)',
            'intrapersonal_score': 'เข้าใจตนเอง (Intrapersonal)',
            'naturalist_score': 'ธรรมชาติวิทยา (Naturalist)',
            'primary_intelligence': 'พหุปัญญาหลัก',
            'secondary_intelligence': 'พหุปัญญารอง'
        }
